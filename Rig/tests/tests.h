 ...
 * @version    $Id: tests.h 977 2011-05-03 13:32:50Z llongi $
 */
...
const uint8_t rand1k[] = tests_random_1k;
const size_t rand1k_len = sizeof(tests_random_1k) - 1;
